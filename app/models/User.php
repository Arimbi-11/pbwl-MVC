...
class User extends Model
{
      ...
      public function save()
      {
            ...
            SET user_email=:user_email, user_password=PASSWORD(:user_password), user_full_name=:user_full_name, user_hp=:user_hp, user_pos=:user_pos, user_role=:user_role, user_aktif=:user_aktif";
            $stmt = $this->db->prepare($query);
      ...
      public function update()
      {
            ...
            if (!empty($user_password)) {
                  ...
                  $query = "UPDATE tb_users
                  SET user_email=:user_email, user_full_name=:user_full_name, user_hp=:user_hp, user_pos=:user_pos, user_role=:user_role, user_aktif=:user_aktif
                  WHERE user_id=:user_id";
            }
