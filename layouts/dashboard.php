...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/logoutama.png" class="brand">
			...
			<ul>
				...
				<li>
					<a href="<?php echo URL; ?>/pelanggan">
						<img class="icon" src="<?php echo AST; ?>/img/pelanggan1.png" alt=""> Pelanggan
					</a>
				</li>
				<li>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2022 - <?php echo date('Y'); ?>. Designed by Arimbikyut
		</footer>
	</main>
